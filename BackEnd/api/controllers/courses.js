...
function estadistica(req, res) {
    ...
    sequelize.query(`select sum(status) as aprobado,round(avg(grade),2) as promedio,a2.code as code_course,a2.ordinal as ordinal,
    ...
    a4.gender as gender_teacher, a4.last_name as lastName_teacher, a4.rut as rut_teacher, a2.year as year, (count(a1.pk)-sum(status)) as reprobados,
    round(coalesce(stddev_samp(grade),0),3) as desviacion , count(a1.pk) as total
...
function estadistica_student(req, res) {
    ...
    sequelize.query(`select a3.code as code, a3.ordinal as ordinal, a3.year as year, a4.code as code_subject, a4.name as name, a4.created as created, a3.section as section, a5.rut as rut_teacher,
    a5.first_name as firsName_teacher, a5.last_name as lastName_teacher, a5.gender as gender_teacher, a5.birthdate as birthdate_teacher, a3.section as section, a1.rut as rut_student, 
    a1.first_name as firstName_student, a1.last_name as lastName_student, a1.gender as gender_student, a1.birthdate as birthdate_student, a2.grade as grade, a2.status as status
    ...
    inner join teachers as a5 on a3.teacher_fk = a5.pk inner join tokens a6 on a1.rut = a6.rut
